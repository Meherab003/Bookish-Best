const About = () => {
  return (
    <div className="flex flex-col gap-4 lg:gap-6 lg:w-11/12 mx-auto">
      <div className="flex flex-col gap-3 bg-[#1313130D] p-3 rounded-xl border">
        <h1 className="text-3xl lg:text-4xl font-bold text-center">About Us</h1>
      ...
      <div className="flex flex-col gap-3 bg-pink-100 p-3 rounded-xl border">
        ...
        <p className="text-[#131313CC] font-medium">
          Our mission is simple: to foster a love for reading. Whether you’re a
          seasoned bibliophile or a curious beginner, we’re here to curate an
          enchanting collection of books that will captivate your mind and touch
          your soul.
        </p>
      </div>
      <div className="flex flex-col gap-3 bg-green-100 p-3 rounded-xl border">
        ...
        <ul className="text-[#131313CC] font-medium list-disc flex flex-col gap-1 p-5">
          ...
          <li>
            Cozy Reading Nooks: Step into our cozy nooks, sip a cup of aromatic
            tea, and lose yourself in the pages of a novel. Our inviting
            ambiance encourages you to linger, explore, and immerse yourself in
            literary adventures.
          </li>
          <li>
            Community Events: Book clubs, author signings, poetry readings—we
            host a variety of events that celebrate the joy of reading. Connect
            with fellow book lovers, share insights, and expand your literary
            horizons.
          </li>
          <li>
      ...
      <div className="flex flex-col gap-3 bg-red-100 p-3 rounded-xl border">
        ...
        <ul className="text-[#131313CC] font-medium list-disc flex flex-col gap-1 p-5">
          ...
          <li>
            Oliver Bennett (Head Librarian): Oliver’s encyclopedic knowledge of
            books is legendary. He can recite opening lines from obscure novels
            and always knows where to find that elusive title you’ve been
            searching for.
          </li>
          <li>
            Sophia Ramirez (Events Coordinator): Sophia infuses our events with
            magic. From themed book parties to midnight release celebrations,
            she ensures that every gathering at BookWorm Haven is unforgettable.
          </li>
        </ul>
      </div>
      <div className="flex flex-col gap-3 bg-blue-100 p-3 rounded-xl border">
        ...
        <p className="text-[#131313CC] font-medium">
          Whether you’re seeking an old favorite or a fresh adventure, BookWorm
          Haven invites you to turn the page and embark on a delightful literary
          journey. Come, explore, and let the words weave their magic. Happy
          reading!
        </p>
      </div>
    </div>
