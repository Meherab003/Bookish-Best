    ...
    <div className="flex flex-col lg:flex-row gap-3 lg:gap-10 lg:px-8 lg:py-4">
      ...
      <div className="flex flex-col gap-3">
        <div className="flex flex-col gap-2 border-b pb-2 border-[#13131326">
          <h3 className="text-2xl lg:text-4xl font-bold primary-font">{bookName}</h3>
        ...
        <div className="flex flex-col gap-4 border-b pb-2 border-[#13131326">
          <p className="lg:w-[500px] text-[#131313CC] font-medium">
          ...
          <p className="text-black font-bold">
            ...
            {tags.map((tag, idx) => (
              <span
                className="font-medium text-[#23BE0A] bg-[#23BE0A0D] mx-3 rounded-3xl px-4 py-2"
                key={idx}
              >
                {tag}
              </span>
        ...
        <table className="text-[#131313CC] font-medium">
          <tbody>
            <tr>
